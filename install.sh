...
# Funkcje logujące (zapisują wyłącznie do pliku logu w tle)
log_info() { echo -e "${INFO}==> $1${NC}"; }
log_ok()   { echo -e "${SUCCESS}✔ $1${NC}"; }
log_err()  { echo -e "${ERROR}✖ BŁĄD: $1${NC}"; }
log_warn() { echo -e "${WARN}⚠ UWAGA: $1${NC}"; }
